...
export default function ChequeVisualizer({ routingNumber, bankName }: { routingNumber: string, bankName?: string }) {
  return (
    <div className="w-full max-w-2xl mx-auto my-8 relative rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-sm bg-[#f8fcf8] text-slate-800 print:hidden font-sans group transition-all duration-300 hover:shadow-md">
