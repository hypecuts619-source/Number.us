...
export default function CheckDiagram({ 
  ...
  return (
    <div className="my-8">
      {/* Interactive Inputs */}
      <div className="max-w-2xl mx-auto mb-6 p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl flex gap-4 items-center shadow-sm">
      ...
      <div className="overflow-x-auto pb-4">
        ...
        <div className="max-w-2xl mx-auto flex gap-4 text-sm font-medium justify-center mt-6 text-slate-600 dark:text-slate-300">
