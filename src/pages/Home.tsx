    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="text-center py-12">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto mb-8">
          Instantly execute a routing number lookup for ACH, direct deposit, and wire transfers. Search official ABA routing numbers and easily find your bank routing number.
        </p>
