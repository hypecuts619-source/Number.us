...
export default function HowToFind() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 w-full">
      <SEO 
        title="How to Find Your Routing Number Online (3 Easy Methods)"
        description="Don't have a checkbook? Learn how to find your routing number online via your bank's app, website, or our verified lookup tool."
      ...
      <div className="mb-10 lg:mb-14 not-prose">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 dark:text-white tracking-tight mb-6 leading-tight">
          How to Find Your Routing Number Online (3 Easy Methods)
        </h1>
